                        ...
                        <div class="hs-carousel relative overflow-hidden w-full bg-transparent rounded-lg">
                            <div class="hs-carousel-body flex flex-nowrap overflow-hidden transition-[height,transform] duration-700 opacity-0">
                                ...
                                <div class="hs-carousel-slide h-80 lg:h-96">
                                    <div class="h-full w-full bg-gray-100 dark:bg-neutral-800 bg-no-repeat bg-center bg-contain"
                                ...
                                <!-- Second Slide -->
                                <div class="hs-carousel-slide h-80 lg:h-96">
                                    <div class="h-full w-full bg-gray-200 dark:bg-neutral-700 bg-no-repeat bg-center bg-contain"
                                ...
                                <!-- Third Slide -->
                                <div class="hs-carousel-slide h-80 lg:h-96">
                                    <div class="h-full w-full bg-gray-300 dark:bg-neutral-600 bg-no-repeat bg-center bg-contain"
